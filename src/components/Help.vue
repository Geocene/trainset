<template>
  <div class="container">
    ...
    <div id="info">
	    ...
	    <p class='text-left'>TRAINSET only accepts specific file formats. This <a href='https://TODO' target='_blank'>sample CSV</a> is formatted correctly. Files uploaded to TRAINSET must have four comma-delimited columms with the header: <code>filename, timestamp, value, label</code>; <code>null</code> data are not allowed.</p>
