<template>
  <div class="container">
    ...
    <div id="info">
	    ...
	    TRAINSET is a client-side application. Although we use the word "upload" to describe importing data into TRAINSET, your time series data and labels are never transferred over the internet or visible to Geocene. Feel free to deploy TRAINSET locally using the instructions in the <a href="https://github.com/geocene/trainset" target="_blank">GitHub ReadMe</a>.
    </div>
  </div>
</template>