    	...
    	<div class="info">
  	    ...
  	    <div class='text-left'>
  		    <ul style="list-style-type:square;">
  				<li><code>series</code> is a unique name of the time series you are labeling. You can include multiple <code>series</code> in a CSV.</li>
  				...
  				<li><code>label</code> is an integer representation of a boolean; <code>0==FALSE</code> and <code>1==TRUE</code>. It is possible to upload data to TRAINSET that is pre-labeled (i.e. the <code>label</code> column does not have to start with all zeros). See the <a href="/static/files/sample_trainset.csv" download>sample CSV</a>.</li>
  		    </ul>
  		  </div>
